...
{not police_interrupts_grieving_mother || grieving_mother_describes_son: {policeman_name} steps up to counter.}
...
*   Let's see...["]Only one left. So five are occupied. Would you like the last one? Is that what this is about?"
-   "Not exactly. I need the directory. It would be stupid to not run some background checks on these people."
*   "Oh...Yeah, that is smart!["] Here you go."
